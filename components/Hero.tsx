...
function HeroArt({ imageUrl }: { imageUrl: string }) {
  ...
  return (
    <svg viewBox="0 0 400 300" preserveAspectRatio="xMidYMid slice" aria-hidden="true">
      ...
      <g opacity=".5" stroke="#e7b662" strokeWidth=".6">
      ...
      <g transform="translate(198,150)">
        <circle r="34" fill="none" stroke="#dd6b40" strokeWidth="1" />
        <circle r="3" fill="#dd6b40" />
        <path d="M0 -46 V-34 M0 34 V46 M-46 0 H-34 M34 0 H46" stroke="#e7b662" strokeWidth="1.4" />
      </g>
      <path
